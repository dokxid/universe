...
sed -i "s|^AWS_SECRET_ACCESS_KEY=.*|AWS_SECRET_ACCESS_KEY=$SECRET_KEY_PRODUCTION|g" $ENV_FILE_PRODUCTION || echo "AWS_SECRET_ACCESS_KEY=$SECRET_KEY_PRODUCTION" >> $ENV_FILE_PRODUCTION
...
sed -i "s|^AWS_SECRET_ACCESS_KEY=.*|AWS_SECRET_ACCESS_KEY=$SECRET_KEY_STAGING|g" $ENV_FILE_STAGING || echo "AWS_SECRET_ACCESS_KEY=$SECRET_KEY_STAGING" >> $ENV_FILE_STAGING
...
sed -i "s|^AWS_SECRET_ACCESS_KEY=.*|AWS_SECRET_ACCESS_KEY=$SECRET_KEY_LOCAL|g" $ENV_FILE_LOCAL || echo "AWS_SECRET_ACCESS_KEY=$SECRET_KEY_LOCAL" >> $ENV_FILE_LOCAL
