        ...
        <SidebarContext.Provider value={contextValue}>
            <TooltipProvider delayDuration={0}>
                <div
                    ...
                    className={cn(
                        "group/sidebar-wrapper has-data-[variant=inset]:bg-sidebar flex min-h-svh h-screen w-full",
                        className
                    )}
                    {...props}
                >
...
function SidebarGroupLabel({
    ...
    return (
        <Comp
            ...
            className={cn(
                "text-[0.65rem] uppercase text-sidebar-foreground/70 ring-sidebar-ring flex h-fit shrink-0 items-center rounded-md px-2 font-medium outline-hidden transition-[margin,opacity] duration-200 ease-linear focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0",
                "group-data-[collapsible=icon]:-mt-8 group-data-[collapsible=icon]:opacity-0 flex items-end py-1",
                className
            )}
            {...props}
        />
