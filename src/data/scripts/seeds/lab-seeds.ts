...
export const stock_labs_doc: Prisma.LabCreateInput[] = [
    {
        slug: "istanbul",
        ...
        content: "<p class='text-node'>Explore Istanbul</p>",
    ...
    },
    {
        ...
        content:
            "<p class='text-node'>Tanzania’s mainland and islands have played a pivotal role in the trade between Africa, Europe, and the East for over a millennia. Trading empires built on slaves, gold, and ivory have risen and fallen over the ages. Fortune seekers, traders, captives, and rulers have brought with them new customs and lifestyles to this East African Coast, blending with the local traditions and culture. \n\nFor many of these inland communities, maritime heritage has often been associated negatively with the history of colonialism and thus neglected. Tanzania’s coastal areas contain a unique representation of a melting pot of cultures; influences from Africa, the Middle East, Europe and the Far East. They represent centuries of global contact.</p>",
        subtitle: "Heritage at a Crossroads",
        initialZoom: 15,
        logo: "https://heritagelab.center/wp-content/uploads/2022/05/Zanzibar-Button-Photo-870x570.jpeg",
        stories: undefined,
        visibility: "public",
    },
    {
        ...
        name: "Kerala",
        content:
            "<p class='text-node'>Kerala, fondly known as ‘God’s Own Country’, is a state nestled along the southwestern coast of the Indian subcontinent. Famous for its lush greenery, tranquil backwaters, and pristine beaches, Kerala is one of India’s most desired tourist destinations.\nThe state of Kerala was formally established in 1956, but the region’s history dates back millenia. Evidence of the first prehistorical settlements in the region have been documented through the numerous mesolithic, neolithic, and megalithic sites found throughout the state. The first recorded mentions of Kerala come much later, in the 3rd century BCE, when the region was governed by the Chera dynasty.</p>",
        subtitle: "Exploring the state of traditional heritage",
        logo: "https://heritagelab.center/wp-content/uploads/2024/02/dd31a775-e3be-4b35-aa45-561b34bc4d03-870x570.jpg",
        stories: undefined,
        visibility: "public",
    },
];

export const universe_lab_doc = (): Prisma.LabCreateInput => {
    return {
        lngCenter: 0,
        latCenter: 0,
        initialZoom: 1,
        ...
        slug: "universe",
        logo: "https://heritagelab.center/wp-content/uploads/2024/07/MS448_A4315_2_15_0032-Large-870x570.jpeg",
        stories: undefined,
        content: "<p class='text-node'>Universe Map</p>",
        visibility: "public",
    };
};

export const test_lab_doc = async (
    slug: string,
    center: number[],
    ...
    return {
        ...
        logo:
            process.env.LOCAL_UPLOADER === "true"
                ...
                "/800/600",
        stories: undefined,
        content: `<p class='text-node'>${faker.lorem.sentence({ min: 40, max: 60 })}</p>`,
